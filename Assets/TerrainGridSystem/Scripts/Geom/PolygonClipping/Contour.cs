...
namespace TGS.Geom {
    public class Contour {
        ...
        public Contour(List<Point> points, int startIndex, int count) {
            this.points = new List<Point>();
            int pointsCount = points.Count;
            int endCount = startIndex + count;
            if (endCount > pointsCount) endCount = pointsCount;
            for (int k = startIndex; k < endCount; k++) {
                this.points.Add(points[k]);
            }
        }
