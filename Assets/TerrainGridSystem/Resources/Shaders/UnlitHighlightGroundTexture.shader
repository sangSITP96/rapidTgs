    ...
    Blend [_SrcBlend] [_DstBlend]
  	...
  	ZTest [_ZTest]
    	...
    	Pass {
			...
			#pragma vertex vert			
			#pragma multi_compile_local _ TGS_TRANSPARENT
			#pragma multi_compile_local _ TGS_TEX_HIGHLIGHT_ADDITIVE TGS_TEX_HIGHLIGHT_MULTIPLY TGS_TEX_HIGHLIGHT_COLOR TGS_TEX_HIGHLIGHT_SCALE TGS_TEX_DUAL_COLORS
